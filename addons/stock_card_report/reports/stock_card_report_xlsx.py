    ...
    def _get_ws_params(self, wb, data, product):
        ...
        stock_card_template = {
            ...
            "5_input": {
                ...
                "data": {"value": self._render("partner")},
                "width": 25,
            },
            "6_input": {
                "header": {"value": "Input"},
        ...
        for line in product_lines:
            ...
            row_pos = self._write_line(
                ...
                render_space={
                    ...
                    "From" : line.location_id.display_name or "",
                    "To"    : line.location_dest_id.display_name or "",
