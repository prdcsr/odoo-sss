...
class SaleOrderLine(models.Model):
    ...
    def onchange_multiple_discount(self):    
        for line in self:
            ...
            if multiple_discount:
                if line._validate_discount(multiple_discount):
                    normalized_discount = line._normalize_discount(
                        multiple_discount)
                else:
                    line.discount = 0
                    raise UserError(
            ...
            #self.get_multiple_discount(self, line.multiple_discount)
    ...
    def product_id_change_multiple_discount(self):
        for line in self:
            line.update({'multiple_discount': False})
