...
class LoyaltyProgram(models.Model):
    ...
    rule_ids = fields.One2many(comodel_name='sale.loyalty.rule',
                               inverse_name='sale_loyalty_program_id',
                               string='Rules')
    reward_ids = fields.One2many(comodel_name='sale.loyalty.reward',
                                 inverse_name='sale_loyalty_program_id',
                                 string='Rewards')
