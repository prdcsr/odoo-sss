...
class ReportMrpBomCurrentStockXlsx(models.AbstractModel):
    ...
    def _print_bom_children(ch, sheet, row):
        ...
        sheet.write(i, 4, ch.qty_req or "")
        sheet.write(i, 5, ch.qty_available_in_source_loc or 0.0)
        sheet.write(i, 6, ch.qty_diff or "")
        sheet.write(i, 7, ch.product_uom_id.name or "")
        sheet.write(i, 8, ch.location_id.name or "")
        sheet.write(i, 9, ch.bom_id.code or "")
        sheet.write(i, 10, ch.bom_id.product_tmpl_id.display_name or "")
        i += 1
        return i
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        for o in objects:
            ...
            sheet.write(i, 4, o.plan_qty or "", bold)
