...
class SaleCoupon(models.Model):
    ...
    program_id = fields.Many2one('stock.equipment.program', "Program", required=True, ondelete="cascade")
    ...
    def _check_coupon_code(self, order):
        ...
        elif self.program_id.program_type == 'coupon_program' and not self.program_id._filter_programs_on_products_equipment(order):
