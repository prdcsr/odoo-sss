odoo.define("sale_product_report.client_action", function(require) {
    "use strict";
    ...
    const AFRReportAction = ReportAction.extend({
        start: function() {
            return this._super.apply(this, arguments).then(() => {
                this.$buttons = $(
                    QWeb.render(
                        "sale_product_report.client_action.ControlButtons",
                        {}
                    )
                );
        ...
        _get_xlsx_name: function(str) {
            ...
            return `s_p_s_r.report_${parts[parts.length - 1]}_xlsx`;
        },
    });

    core.action_registry.add("sale_product_report.client_action", AFRReportAction);
